<style>
     #event_page_wrap p.ia-text-logo.desktop {
    display: none;
}
</style>
                            ...
                            <table class="table">
                                        ...
                                        <td style="width:200px; text-align: right;">
                                            <div class="ticket-pricing" style="margin-right: 20px;">
                                                ...
                                                @else
                                                    ...
                                                    $is_free_event = false;
                                                    ?>
                                                    <span title='{{money($ticket->price, $event->currency)}} @lang("Public_ViewEvent.ticket_price") + {{money($ticket->total_booking_fee, $event->currency)}} @lang("Public_ViewEvent.booking_fees")'>{{money($ticket->price, $event->currency)}} + {{money($ticket->total_booking_fee, $event->currency)}} </span>
                                    ...
                                    <td colspan="3"  style="text-align: left">
                                        ...
                                        <div class="form-group" style="display:inline-block;margin-bottom:0;margin-left:15px;">
                                            ...
                                            {!! Form::button(trans("basic.apply"), [
                                                ...
                                                'style' => 'display:inline-block;margin-top:-2px !important;',
                                                'data-dismiss' => 'modal',
                                            ]) !!}
                                        </div>
                                    </td>
                                ...
                                <tr class="checkout">
                                    <td colspan="3" style="text-align: center">
                                        ...
                                        @endif
                                        {!!Form::submit(trans("Public_ViewEvent.register"), ['class' => 'btn btn-lg btn-primary buy'])!!}
                                    </td>
                                </tr>
                            </table>
                        </div>
