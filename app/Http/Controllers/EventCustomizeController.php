...
class EventCustomizeController extends MyBaseController
{
    ...
    public function postEditEventFees(Request $request, $event_id)
    {
        ...
        $rules = [
            'organiser_fee_percentage' => ['numeric', 'between:12,12'],
    ...
    public function postEditEventDesign(Request $request, $event_id)
    {
        ...
        $event->bg_image_path = $request->get('event_image');
        ...
        if ($request->hasFile('event_image')) {
            ...
            $filename = 'event_bg-' . md5($event->id) . '.' . strtolower($request->file('event_image')->getClientOriginalExtension());
