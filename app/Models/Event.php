...
class Event extends MyBaseModel
{
    ...
    {
        return "<!--Inverted Audio Ticketing Embed Code-->
                <iframe id='ticket' frameBorder='0' seamless='seamless' src='" . $this->embed_url . "' allowtransparency='true'></iframe>
                <!--/Inverted Audio Ticketing Embed Code-->";
    }
